...
var _highlightJsLibHighlight = require('highlight.js/lib/highlight');
    ...
    _createClass(Highlight, [{
        ...
        value: function highlightCode() {
            ...
            languages.forEach(function (lang) {
                _highlightJsLibHighlight2['default'].registerLanguage(lang, require('highlight.js/lib/languages/' + lang));
            });

            var i = undefined;
            for (i = 0; i < nodes.length; i++) {
                _highlightJsLibHighlight2['default'].highlightBlock(nodes[i]);
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var innerHTML = _props2.innerHTML;
